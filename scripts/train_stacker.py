"""
Train a stacking meta-classifier on outputs/val_calib.npz

Outputs:
 - outputs/stacker.joblib
 - outputs/stacker_eval.json
...
def main():
    ...
    parser.add_argument('--input', default='outputs/val_calib.npz')
    parser.add_argument('--out', default='outputs/stacker.joblib')
