...
class FractureDataset(Dataset):
    def __init__(self, csv_file, image_root_dir, processor):
...
def main():
    ...
    # Prepare datasets
    train_dataset = FractureDataset(args.train_csv, args.data_root, processor)
    val_dataset = FractureDataset(args.val_csv, args.data_root, processor)
