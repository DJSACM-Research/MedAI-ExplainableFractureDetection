"""
Test Combo 4: hypercolumn_cbam_densenet169_focal, rad_dino, yolo
...
def main():
    ...
    print("="*70)
    print("TEST COMBO 4: hypercolumn_cbam_densenet169_focal, rad_dino, yolo")
    print("="*70)
    ...
    if y_true:
        print("\n" + "="*70)
        print("TEST COMBO 4 RESULTS - STACKING ENSEMBLE EVALUATION")
        print("="*70)
