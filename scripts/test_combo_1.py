"""
Test Combo 1: maxvit, hypercolumn_cbam_densenet169_focal, yolo
...
def main():
    ...
    print("="*70)
    print("TEST COMBO 1: maxvit, hypercolumn_cbam_densenet169_focal, yolo")
    print("="*70)
    ...
    if y_true:
        print("\n" + "="*70)
        print("TEST COMBO 1 RESULTS - STACKING ENSEMBLE EVALUATION")
        print("="*70)
