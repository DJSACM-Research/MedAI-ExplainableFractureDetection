"""
Test Combo 2: maxvit, hypercolumn_cbam_densenet169_focal, rad_dino
...
def main():
    ...
    print("="*70)
    print("TEST COMBO 2: maxvit, hypercolumn_cbam_densenet169_focal, rad_dino")
    print("="*70)
    ...
    if y_true:
        print("\n" + "="*70)
        print("TEST COMBO 2 RESULTS - STACKING ENSEMBLE EVALUATION")
        print("="*70)
