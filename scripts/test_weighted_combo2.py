"""
Test Weighted Ensemble - Combo 2: maxvit, hypercolumn_focal, rad_dino
"""
...
model_weights = {"maxvit": 0.30, "hypercolumn_cbam_densenet169_focal": 0.40, "rad_dino": 0.30}

print("=" * 80)
print("WEIGHTED ENSEMBLE - COMBO 2 (maxvit, hypercolumn_focal, rad_dino)")
print("=" * 80)
...
if y_true:
    ...
    print("\n" + "=" * 80)
    print("RESULTS - COMBO 2 (WEIGHTED)")
    print("=" * 80)
