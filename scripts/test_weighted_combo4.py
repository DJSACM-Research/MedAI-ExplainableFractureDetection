"""
Test Weighted Ensemble - Combo 4: hypercolumn_focal, rad_dino, yolo
"""
...
model_names = ["hypercolumn_cbam_densenet169_focal", "rad_dino", "yolo"]
model_weights = {"hypercolumn_cbam_densenet169_focal": 0.40, "rad_dino": 0.30, "yolo": 0.30}

print("=" * 80)
print("WEIGHTED ENSEMBLE - COMBO 4 (hypercolumn_focal, rad_dino, yolo)")
print("=" * 80)
...
if y_true:
    ...
    print("\n" + "=" * 80)
    print("RESULTS - COMBO 4 (WEIGHTED)")
    print("=" * 80)
