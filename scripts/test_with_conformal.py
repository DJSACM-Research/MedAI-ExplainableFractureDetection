...
Outputs a JSON file `outputs/test_with_conformal.json` containing a list of results.
"""
import argparse
import json
import os
...
def main():
    ...
    parser.add_argument('--output', type=str, default='outputs/test_with_conformal.json', help='Output JSON path')
