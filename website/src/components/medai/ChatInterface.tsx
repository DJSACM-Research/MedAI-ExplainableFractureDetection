...
export function ChatInterface({ context }: ChatInterfaceProps) {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: "system", content: "⚠️ Error communicating with the medical assistant (or potential rate limit). Please try again in a moment." }]);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <Card className="h-[600px] flex flex-col">
      ...
      <CardContent className="flex-1 flex flex-col gap-4 overflow-hidden p-4 pt-0">
        ...
        {/* User Data Section */}
        <Accordion type="single" collapsible className="w-full border rounded-lg px-2 shadow-sm bg-secondary/10">
            ...
            <AccordionContent>
              <div className="grid grid-cols-2 gap-3 p-1">
                ...
                <div className="col-span-2 space-y-1">
                  <Label htmlFor="history" className="text-xs">Medical History</Label>
                  <Input
                    id="history"
          ...
          <div className="flex flex-col gap-4 py-2">
                ...
                <div className={`
                  ...
                  ${m.role === 'user' 
                    ...
                    : m.role === 'system'
                      ...
                      : 'bg-white text-neutral-900 border border-neutral-200 rounded-tl-none dark:bg-neutral-800 dark:text-neutral-100 dark:border-neutral-700'
                  }
                `}>
            ...
            {isLoading && (
              <div className="flex gap-3 justify-start">
                 ...
                 <div className="bg-white border border-neutral-200 rounded-2xl rounded-tl-none p-4 dark:bg-neutral-800 dark:border-neutral-700">
        ...
        <div className="flex gap-2 pt-2 border-t">
          <Input 
            ...
            className="flex-1"
          />
          <Button size="icon" onClick={sendMessage} disabled={isLoading} className="bg-blue-600 hover:bg-blue-700">
