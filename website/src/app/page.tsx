...
import { ArrowRight, Activity, ShieldCheck, Brain, Stethoscope, Lightbulb, MessageSquare } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <header className="px-6 lg:px-12 h-20 flex items-center justify-between border-b border-white/10 backdrop-blur-md sticky top-0 z-50">
        ...
        <nav className="hidden md:flex gap-8 text-sm font-medium text-muted-foreground">
          ...
          <Link href="https://github.com/DJSACM-Research/MedAI-ExplainableFractureDetection" target="_blank" className="hover:text-white transition-colors">GitHub</Link>
        </nav>
        <Link href="/diagnose">
        ...
        <section className="relative pt-20 pb-32 px-6 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              A state-of-the-art multi-agent system combining deep learning ensembles, explainable AI, and medical knowledge retrieval for accurate and transparent diagnoses.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link href="/diagnose">
                <Button size="lg" className="h-12 px-8 text-lg bg-blue-600 hover:bg-blue-700 shadow-xl shadow-blue-500/20 transition-all hover:scale-105">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 space-y-4">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our system uses a novel multi-agent architecture to provide more than just a prediction. It explains, educates, and answers your questions.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Combines 9 Deep Learning models including DenseNet, Swin Transformer, and MaxViT for robust accuracy."
                },
                {
                  icon: ShieldCheck,
                ...
                <div key={i} className="group p-6 rounded-2xl border border-white/5 bg-white/5 hover:bg-white/10 transition-all hover:-translate-y-1">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden border border-white/10 bg-white/5 flex items-center justify-center">
              ...
              <div className="text-center p-8">
                ...
                <p className="text-xl font-medium">Processing Pipeline Visualization</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="py-8 border-t border-white/10 text-center text-muted-foreground text-sm">
        <p>© 2025 MedAI Research. Created with love by the DJSCE-ACM Team.</p>
      </footer>
    </div>
  );
}
